...
<body>
  <div class="container mt-5">
    ...
    <div class="row mt-5">
      <div class="col-md-6">
        <p>Foto Profil</p>
        <img class="" src="https://cdn.dribbble.com/users/5534/screenshots/14230133/profile_4x.jpg" width="100"
          alt="" />
    ...
    <form method="post" action="./Controller/c_updateprofil.php">
      <h2 class="text-center mt-4">Ganti Username dan Email</h2>
      <div class="mt-4 row">
        <div class="col">
          <p>Nama Lengkap</p>
          <input type="text" class="form-control mt-2" placeholder="<?php echo $_SESSION['username']; ?>"
            name="full_name" />
        </div>
        <div class="col">
          <p>Email ID</p>
          <input type="text" class="form-control mt-2" placeholder="<?php echo $_SESSION['email']; ?>" name="email" />
        </div>
      </div>
